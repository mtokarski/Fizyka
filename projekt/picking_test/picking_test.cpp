...
void UpdateScene(double deltaTime) 
{
	...
	{
		// conect mouse to the dragged point using spring equation
		Vec3d force(0.0);
...
void DrawBox()
{
	...
	glPushMatrix();		
		glTranslated(g_box.CenterX(), g_box.CenterY(), g_box.CenterZ());
		glScaled(g_box.SizeX(), g_box.SizeY(), g_box.SizeZ());
